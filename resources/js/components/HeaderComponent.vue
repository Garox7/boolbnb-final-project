<template>
    <div>
        <!-- barra di ricerca mobile (max: 744px) -->
        <header class="header-mobile">
            <div class="mobile-search">
                ...
                <span class="search-input">
                    <input type="search" name="search" id="search" placeholder="Dove vuoi andare?">
                </span>
        ...
        <nav class="mobile-nav">
            ...
            <div class="nav-container">
                ...
                <a :href="isLoggedIn ? '/admin' : '/login'" class="nav-button">
                    <div class="icon-button">
                    ...
                    <span>{{ isLoggedIn ? 'Profilo' : 'Accedi' }}</span>
                </a>
            </div>
        </nav>

        <!-- nav desktop, (min:744px) -->
        <nav class="desktop-nav">
            <!-- logo -->
            <div class="nav-logo">
                <router-link :to="{name: 'home'}" class="logo-link">
                    <svg class="logo-icon" width="30" height="32">
            ...
            <div class="desktop-search">
                <div class="search-container">
                    ...
                    <span class="search-input">
                        <input type="search" name="search" id="search" placeholder="Dove vuoi andare?" v-model="searchAddress">
                    </span>

                    <button class="search-filter" @click="$emit('searchProperty', searchAddress)">
                        <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 16px; width: 16px; fill: rgb(34, 34, 34);">
                            <path d="M5 8c1.306 0 2.418.835 2.83 2H14v2H7.829A3.001 3.001 0 1 1 5 8zm0 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm6-8a3 3 0 1 1-2.829 4H2V4h6.17A3.001 3.001 0 0 1 11 2zm0 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"></path>
                        </svg>
                    </button>
