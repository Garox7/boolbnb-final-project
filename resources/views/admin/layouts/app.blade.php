            ...
            <div class="user-controls">
                ...
                <div class="controls">
                    ...
                    <div class="drop-menu hidden">
                        <div class="drop-item">
                            <a class="drop-link" href="{{ route('admin.properties.index') }}">Le mie Proprietà</a>
                        </div>
                        <div class="drop-item">
                            <a class="drop-link" href="{{ route('admin.properties.create') }}">Aggiungi Proprietà</a>
                        </div>
                        <div class="drop-item">
                            <a class="drop-link" href="{{ route('admin.dashboard') }}">Profilo</a>
                        </div>
